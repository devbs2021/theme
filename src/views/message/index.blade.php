...
{{$dataTable->scripts()}}
<script>
    $('.message-menu').removeClass('menu-is-opening menu-open');
    $('.message-menu').addClass('menu-is-opening menu-open');
    $('.message-menu').find('>:first-child').removeClass('active');
    $('.message-menu').find('>:first-child').addClass('active');
    $(function(){
