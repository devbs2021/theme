    ...
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Update CMS</h3>
            ...
            <div class="card-body">
                ...
                @endif
                <form class="row form" method="post" action="{{ route('cms.update',$cms->id) }}"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" class="form-control" name="description" rows="5"
                                placeholder="Enter Description">{{ $cms->description }}</textarea>
                        </div>
                        <!-- /.form-group -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select name="cms_id" class="form-control select2">
                                ...
                                @if($parent->id!=$cms->id)
                                <option value="{{ $parent->id }}" {{ ($cms->cms_id==$parent->id)?'selected':'' }}>
                                    {{ $parent->title }}</option>
                                @endif
                                @endforeach
                            </select>
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control" id="meta_title" name="meta_title"
                                    placeholder="Enter Meta Title" value="{{ $cms->seo['meta_title']??'' }}">
                            </div>
                            <!-- /.card-body -->
                            <div class="card-body">
                                <label>Meta Description</label>
                                <textarea class="form-control" name="meta_description" rows="5"
                                    placeholder="Enter Meta Description">{{ $cms->seo['meta_description']??'' }}</textarea>
                            </div>
                        </div>
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <input type="checkbox" name="status" value="1" data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success" {{ ($cms->status)?'checked':'' }}>
                            </div>
                        </div>
